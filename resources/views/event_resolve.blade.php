...
@section('content')
<form id="form_1085042" class="appnitro"  method="post" action="event_resolveForm">
...
<label class=" choice" for="element_15_1">YES</label> <br>
		...
		<div>
			<textarea id="element_3" name="explanation" class="form-control element textarea medium"></textarea> 
		</div> 
