...
<label class=" choice" for="element_15_1">YES</label> <br>
		...
		<div>
			<input id="element_9" name="element_9" class="form-control element text medium" type="number" maxlength="16" value=""/> 
		</div> 

		<label class="description" for="element_2">Title </label>
		<div>
			<input id="element_2" name="element_2" class="form-control element text medium" type="text" maxlength="255" value=""/> 
		</div> 

		<label class="description" for="element_3">Explain your problem to us in detail. </label>
		<div>
			<textarea id="element_3" name="element_3" class="form-control element textarea medium"></textarea> 
		</div> 
