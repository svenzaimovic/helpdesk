...
//Auth routes
Route::get('bank-helpdesk/public/auth/login', 'Auth\AuthController@getLogin');
Route::post('bank-helpdesk/public/auth/login', 'Auth\AuthController@postLogin');
Route::get('bank-helpdesk/public/auth/logout', 'Auth\AuthController@getLogout');

// Registration routes...
Route::get('bank-helpdesk/public/auth/register', 'Auth\AuthController@getRegister');
Route::post('bank-helpdesk/public/auth/register', 'Auth\AuthController@postRegister');
